...
function validActivity(id = "validation-fixture") {
  return {
    ...
    pedagogicalQuestion: "",
    video: clone(video),
    transcription: { id: `transcription-${id}`, languageId: "language-1", segmentIds: ["segment-1"] },
    segments: [{ id: "segment-1", startMs: 0, endMs: 1000, text: "Segment", speakerIds: ["speaker-1"], languageIds: ["language-1"], phenomenonIds: ["phenomenon-1"] }],
    speakers: [{ id: "speaker-1", label: "Locuteur" }],
    languages: [{ id: "language-1", code: "FR", label: "français" }],
    languageIntervals: [{ id: "interval-1", languageId: "language-1", segmentId: "segment-1", startMs: 0, endMs: 1000 }],
